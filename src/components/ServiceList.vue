...
import relaxingMassageImage from '../assets/Massagem Relaxante.avif'
import rejuvenationImage from '../assets/rejuvenescimento.jpg'
import cuppingTherapyImage from '../assets/Ventosaterapia.jpeg'
